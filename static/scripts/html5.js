...
(function (l, f) {
    ...
    function q(a) {
        ...
        if (e.shivCSS && !j && !b.hasCSS) {
            ...
            c.innerHTML = "x<style>article,aside,dialog,figcaption,figure,footer,header,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}</style>";
